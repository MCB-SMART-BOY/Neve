...
// (n3v3-cli/src/commands/) via symlink n3v3-cli/docs/ → docs/
...
const DOC_LSP: &str = include_str!("../../docs/reference/lsp.md");
const DOC_STABILITY: &str = include_str!("../../docs/reference/stability.md");
const DOC_ECOSYSTEM_DESIGN: &str = include_str!("../../docs/project/ecosystem-design.md");
const DOC_REGISTRY: &str = include_str!("../../docs/project/registry.md");
...
const TOPICS: &[(&str, &str, &str)] = &[
    ...
    ("lsp", DOC_LSP, "Language Server Protocol / 语言服务器协议"),
    ("stability", DOC_STABILITY, "Stability policy / 稳定性策略"),
    (
        "ecosystem-design",
        DOC_ECOSYSTEM_DESIGN,
        "Ecosystem design / 生态系统设计",
    ),
    ("registry", DOC_REGISTRY, "Package registry / 软件包注册表"),
