//! Registry client for n3v3 v1 package registry API.
//! n3v3 v1 包注册表 API 客户端。
...
/// Client for the n3v3 v1 package registry.
/// n3v3 v1 包注册表客户端。
...
impl RegistryClient {
    ...
    /// Create a client from the N3V3_REGISTRY environment variable.
    /// 从 N3V3_REGISTRY 环境变量创建客户端。
    pub fn from_env() -> Option<Self> {
        std::env::var("N3V3_REGISTRY").ok().map(Self::new)
    }
