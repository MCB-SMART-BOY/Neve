//! Error codes for n3v3 diagnostics.
//! n3v3 诊断的错误代码。
...
impl ErrorCode {
    ...
    /// Get an extended explanation for the error, suitable for `n3v3 --explain`.
    /// 获取错误的扩展说明，适用于 `n3v3 --explain`。
    ...
    pub fn doc_url(&self) -> String {
        const BASE_URL: &str =
            "https://github.com/MCB-SMART-BOY/n3v3/blob/master/docs/reference/diagnostics.md#";
