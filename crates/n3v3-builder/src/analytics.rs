//! Build analytics and visualization for n3v3.
//! n3v3 的构建分析和可视化。
//!
...
impl BuildAnalytics {
    ...
    pub fn summary_report(&self) -> String {
        ...
        report.push_str("╔══════════════════════════════════════════════════════════════╗\n");
        report.push_str("║                    n3v3 Build Analytics                      ║\n");
        report.push_str("║                    n3v3 构建分析报告                         ║\n");
        report.push_str("╠══════════════════════════════════════════════════════════════╣\n");
    ...
    pub fn to_dot(&self) -> String {
        ...
        dot.push_str("digraph n3v3_build {\n");
...
mod tests {
    ...
    fn test_dot_export() {
        ...
        assert!(dot.contains("digraph n3v3_build"));
