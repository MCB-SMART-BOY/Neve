...
pub fn builtins() -> Vec<(&'static str, Value)> {
    vec![
        ("result.ok", Value::Builtin(BuiltinFn {
            name: "result.ok",
            arity: 1,
            func: |args| {
        ...
        ("result.err", Value::Builtin(BuiltinFn {
            name: "result.err",
            arity: 1,
            func: |args| {
        ...
        ("result.is_ok", Value::Builtin(BuiltinFn {
            name: "result.is_ok",
            arity: 1,
            func: |args| {
        ...
        ("result.is_err", Value::Builtin(BuiltinFn {
            name: "result.is_err",
            arity: 1,
            func: |args| {
        ...
        ("result.unwrap", Value::Builtin(BuiltinFn {
            name: "result.unwrap",
            arity: 1,
            func: |args| {
                match &args[0] {
        ...
        ("result.unwrap_err", Value::Builtin(BuiltinFn {
