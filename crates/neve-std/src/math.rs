...
pub fn builtins() -> Vec<(&'static str, Value)> {
    vec![
        // Basic math
        ("math.abs", Value::Builtin(BuiltinFn {
            name: "math.abs",
            arity: 1,
            func: |args| {
                match &args[0] {
        ...
        ("math.floor", Value::Builtin(BuiltinFn {
            name: "math.floor",
            arity: 1,
            func: |args| {
                match &args[0] {
        ...
        ("math.ceil", Value::Builtin(BuiltinFn {
            name: "math.ceil",
            arity: 1,
            func: |args| {
                match &args[0] {
        ...
        ("math.round", Value::Builtin(BuiltinFn {
            name: "math.round",
            arity: 1,
            func: |args| {
                match &args[0] {
        ...
        ("math.sqrt", Value::Builtin(BuiltinFn {
            name: "math.sqrt",
            arity: 1,
            func: |args| {
                match &args[0] {
        ...
        ("math.pow", Value::Builtin(BuiltinFn {
            name: "math.pow",
            arity: 2,
            func: |args| {
                match (&args[0], &args[1]) {
        ...
        ("math.log", Value::Builtin(BuiltinFn {
            name: "math.log",
            arity: 1,
            func: |args| {
                match &args[0] {
        ...
        ("math.log10", Value::Builtin(BuiltinFn {
            name: "math.log10",
            arity: 1,
            func: |args| {
                match &args[0] {
        ...
        ("math.exp", Value::Builtin(BuiltinFn {
            name: "math.exp",
            arity: 1,
            func: |args| {
                match &args[0] {
        ...
        // Trigonometry
        ("math.sin", Value::Builtin(BuiltinFn {
            name: "math.sin",
            arity: 1,
            func: |args| {
                match &args[0] {
        ...
        ("math.cos", Value::Builtin(BuiltinFn {
            name: "math.cos",
            arity: 1,
            func: |args| {
                match &args[0] {
        ...
        ("math.tan", Value::Builtin(BuiltinFn {
            name: "math.tan",
            arity: 1,
            func: |args| {
                match &args[0] {
        ...
        // Comparison
        ("math.max", Value::Builtin(BuiltinFn {
            name: "math.max",
            arity: 2,
            func: |args| {
                match (&args[0], &args[1]) {
        ...
        ("math.min", Value::Builtin(BuiltinFn {
            name: "math.min",
            arity: 2,
            func: |args| {
                match (&args[0], &args[1]) {
        ...
        ("math.clamp", Value::Builtin(BuiltinFn {
            name: "math.clamp",
            arity: 3,
            func: |args| {
        ...
        // Type conversion
        ("math.toInt", Value::Builtin(BuiltinFn {
            name: "math.toInt",
            arity: 1,
            func: |args| {
                match &args[0] {
        ...
        ("math.toFloat", Value::Builtin(BuiltinFn {
            name: "math.toFloat",
            arity: 1,
            func: |args| {
                match &args[0] {
        ...
        // Predicates
        ("math.isNan", Value::Builtin(BuiltinFn {
            name: "math.isNan",
            arity: 1,
            func: |args| {
                match &args[0] {
        ...
        ("math.isInf", Value::Builtin(BuiltinFn {
            name: "math.isInf",
            arity: 1,
            func: |args| {
                match &args[0] {
