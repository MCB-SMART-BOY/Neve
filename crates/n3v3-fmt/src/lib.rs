//! Code formatter for n3v3.
//! n3v3 代码格式化器。
//!
//! This crate provides functionality for formatting n3v3 source code
//! according to a consistent style.
//! 本 crate 提供按照一致风格格式化 n3v3 源代码的功能。
