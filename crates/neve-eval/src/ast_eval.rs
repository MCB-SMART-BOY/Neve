...
//! 适用于快速原型开发和 REPL。
//!
//! **Deprecated**: This module is the AST compatibility path. It will be
//! removed in v4.0. New code should use the HIR evaluator
//! (`neve_eval::Evaluator`) instead.
//!
//! ## Features 功能
//!
#![allow(deprecated)]
...
/// 以便在多次求值之间保持持久状态。
#[deprecated(since = "3.18.0", note = "AST compat path will be removed in v4.0. Use HIR evaluator via neve_eval::Evaluator instead.")]
