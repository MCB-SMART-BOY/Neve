//! Standard library for n3v3.
//! n3v3 标准库。
//!
//! This crate provides the built-in functions and types for n3v3.
//! 本 crate 提供 n3v3 的内置函数和类型。
...
/// Delegates to n3v3_common::is_effectful_builtin (single source of truth).
