...
mod tests {
    ...
    fn test_module_builder() {
        let module = Module::new("test")
            .import("./base.neve")
            .set("hostname", Value::String("test-host".to_string().into()));
    ...
    fn test_module_to_system_config() {
        ...
        let module = Module::new("test")
            .set("hostname", Value::String("test-host".to_string().into()))
            .set("timezone", Value::String("UTC".to_string().into()))
            .set("packages", Value::List(Rc::new(vec![
                Value::String("vim".to_string().into()),
                Value::String("git".to_string().into()),
            ])));
