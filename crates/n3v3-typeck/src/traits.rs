...
//! 特征解析与检查。
//!
//! This module implements trait resolution for n3v3's type system.
//! 本模块实现 n3v3 类型系统的特征解析。
//!
//! It handles:
//! 主要处理：
...
use n3v3_hir::{DefId, GenericParam, ImplDef, TraitDef, Ty, TyKind};
use std::collections::HashMap;

/// Trait and impl identifiers are now `DefId` from `n3v3_hir` directly.
/// This ensures consistency across module boundaries since DefIds
/// are assigned during HIR lowering and are shared.
/// 特征和实现的标识符现在直接使用 n3v3_hir 的 DefId，
