//! Language Server Protocol implementation for n3v3.
//! n3v3 的语言服务器协议实现。
//!
//! This crate provides an LSP server for n3v3, enabling IDE features like:
//! 本 crate 提供 n3v3 的 LSP 服务器，支持以下 IDE 功能：
//!
...
pub use n3v3_diagnostic::{Diagnostic, Severity as DiagnosticSeverity};
pub use semantic_tokens::{
    comment_token_type, generate_semantic_tokens, generate_semantic_tokens_from_ast,
    generate_semantic_tokens_with_context, highlight_terminal, parameter_token_type,
