...
| 方法调用语法 `x.foo(y)` | ✅ | ✅ | ⚠️ | ⚠️ | ✅ | ⚠️ | HIR runtime 已可借助前端携带的静态 resolution 调用具体 impl method；AST/CLI 路径仍未闭环，方法系统也还不是完全稳定的一等语义 |
...
| Unreachable pattern 警告 | N/A | N/A | ❌ | N/A | N/A | ❌ | 和穷尽性同类，能力未正式落地 |
