...
// Module: Neve
// Imports: public import Init public import Neve.Syntax public import Neve.Types public import Neve.Eval public import Neve.Safety
#include <lean/lean.h>
...
lean_object* initialize_NeveFormal_Neve_Safety(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_NeveFormal_Neve_Safety(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
