...
// Module: Neve.Spec.Eval
// Imports: public import Init public import Neve.Spec.Syntax public import Neve.Spec.Typing
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_NeveFormal_Neve_Spec_Eval(uint8_t builtin) {
lean_object * res;
