...
-- ============================================================
-- Size limits (synced with Rust: crates/n3v3-std/src/io/mod.rs)
-- ============================================================
...
inductive EffectEval : Env → IOState → Expr → Value → IOState → Prop where
  ...
  /--
    ...
    Models: builtin_exec_streaming in crates/n3v3-eval/src/eval.rs
  -/
  ...
  /--
    ...
    Models: builtin_exec_pipeline_streaming in crates/n3v3-eval/src/eval.rs
  -/
  ...
  /--
    ...
    Models: builtin_exec_streaming_with_timeout in crates/n3v3-eval/src/eval.rs
  -/
  ...
  /--
    ...
    Models: builtin_read_file_lines in crates/n3v3-eval/src/eval.rs
  -/
